<script setup>
import DangerButton from "@starter/Components/Buttons/DangerButton.vue";
                        ...
                        >
                            <div class="p-6 pb-0">
                                <div class="flex items-start">
                                    <div
                                        class="flex flex-shrink-0 items-center justify-center rounded-full mx-0 h-10 w-10 bg-red-100 dark:bg-red-500"
                                    >
