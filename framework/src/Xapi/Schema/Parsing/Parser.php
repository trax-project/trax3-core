...
namespace Trax\Framework\Xapi\Schema\Parsing;

use Closure;
use Illuminate\Support\Str;
use Trax\Framework\Http\Validation\Validator;
use Trax\Framework\Xapi\Schema\Contracts\Schema;
...
class Parser
{
     ...
     * Validation schema.
     *
     * @var \Trax\Framework\Xapi\Schema\Contracts\Schema
     */
    protected $schema;
     ...
     * Constructor.
     *
     * @param  \Trax\Framework\Xapi\Schema\Contracts\Schema  $schema
     * @return void
     */
    ...
    protected function parseObjectWithSchema($object, array $schema, string $path = '', array $errors = []): array
    {
        ...
        foreach ($schema as $prop => $val) {
            if (in_array('required', $val) && (!isset($objectProps[$prop]) || $objectProps[$prop] === '')) {
